...
def init(env, env_name):
    ...
    if env_name == 'Pendulum-v0':
        ...
        action_range = -2.0
        i = 0
        while action_range <= 2:
            action_dict[i] = action_range
            i +=1
            action_range += 0.1
    else:
...
def get_network(state_dim, action_dim, hidden_nodes=HIDDEN_NODES):
    ...
    #layer 1
    W1shape = [state_dim, hidden_nodes]
    ...
    W2shape = [hidden_nodes, hidden_nodes]
    ...
    W3shape = [hidden_nodes, action_dim]
